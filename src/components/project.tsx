...
const Project = ({ title, description, tags, imageUrl }: ProjectProps) => {
   ...
   return (
      ...
      >
         <section className="relative bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden group-even:pl-8 sm:pr-8 hover:bg-gray-200 transition rounded-md">
